...
import { ChevronDown, Tag, User, Calendar, ExternalLink } from "lucide-react";
...
export function ResearchSection() {
  ...
  return (
    <div id="research" data-testid="research-section">
      {/* Tags Filter */}
      {allTags.length > 0 && (
      ...
      <div className="space-y-4">
        {isLoading ? (
          ...
          <div className="text-center py-12 text-on-surface-variant/70 border border-dashed border-outline-variant/40 rounded-2xl">
            <p className="text-sm">Research papers and publications are loading from the live repository.</p>
          </div>
        ) : (
          filtered.map((r) => {
